    ...
    <div class="col">
        <div class="d-flex align-items-center justify-content-end">
            ...
            <div class="ms-2 btn-group">
                <div class="btn-group">
                    <a href="<?= build_filter_url(['per_page' => 8]) ?>" class="btn <?= is_filter_active('per_page', 8) || ($per_page == 8 )? 'btn-primary' : 'btn-secondary'?>">8</a>
                    <a href="<?= build_filter_url(['per_page' => 16]) ?>" class="btn <?= is_filter_active('per_page', 16) || ($per_page == 16 )? 'btn-primary' : 'btn-secondary'?>">16</a>
                    <a href="<?= build_filter_url(['per_page' => 24]) ?>" class="btn <?= is_filter_active('per_page', 24) || ($per_page == 24 )? 'btn-primary' : 'btn-secondary'?>">24</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <?php if (!is_filter_active('alcool',['0','1'])) { ?>
                    <div class="btn-group">
                        <input type="radio" class="btn-check" name="alcool" value="1" id="alcool-r-2" autocomplete="off">
                        <label for="alcool-r-2" class="btn btn-sm btn-outline-primary">Avec alcool</label>
                        <input type="radio" class="btn-check" name="alcool" value="0" id="alcool-r-3" autocomplete="off">
                        <label for="alcool-r-3" class="btn btn-sm btn-outline-primary">Sans alcool</label>
                    </div>
                <hr>
                <?php } ?>
                <div class="my-2">
