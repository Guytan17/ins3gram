...
class RecipeSeeder extends Seeder
{
    public function run()
    {
        ...
        // Opinions pour les nouvelles recettes
        $opinions = [
            [
                'comments'  => 'Aussi effrayant à boire qu\'à réciter devant son miroir',
                'score'     => 1,
                'id_recipe' => 1,
                'id_user'   => 1,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'Je ne comprends pas ce que vient faire la tomate ici, mais ça se laisse boire',
                'score'     => 3,
                'id_recipe' => 1,
                'id_user'   => 2,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'ça ne pouvait pas être mauvais',
                'score'     => 4,
                'id_recipe' => 2,
                'id_user'   => 1,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'Le citron fait la diff',
                'score'     => 5,
                'id_recipe' => 2,
                'id_user'   => 2,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'Un classique, habitué des happy hour',
                'score'     => 4,
                'id_recipe' => 3,
                'id_user'   => 1,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'Faut aimer la menthe quoi',
                'score'     => 2,
                'id_recipe' => 3,
                'id_user'   => 2,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'ça change, mais j\'en reprendrai pas tous les jours',
                'score'     => 3,
                'id_recipe' => 4,
                'id_user'   => 2,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'le Tonic, quelle horreur',
                'score'     => 1,
                'id_recipe' => 5,
                'id_user'   => 1,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'Voilà enfin une bonne place pour l\'ananas',
                'score'     => 4,
                'id_recipe' => 6,
                'id_user'   => 1,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'Doux et se boit sans soif, un bon moyen de se picher la gueule',
                'score'     => 5,
                'id_recipe' => 6,
                'id_user'   => 2,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'ça arrache un peu mais c\'est pas mal',
                'score'     => 3,
                'id_recipe' => 7,
                'id_user'   => 1,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'Pas commun de mettre un oeuf dans un cocktail mais ça passe bien',
                'score'     => 4,
                'id_recipe' => 8,
                'id_user'   => 1,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'Découverte surprenante mais intéressante',
                'score'     => 4,
                'id_recipe' => 8,
                'id_user'   => 2,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'je n\'en recommanderai pas',
                'score'     => 2,
                'id_recipe' => 9,
                'id_user'   => 1,
                'created_at'=> date("Y-m-d H:i:s"),
            ...
            [
                'comments'  => 'Meilleur avec du rhum brun mais ça se boît',
                'score'     => 4,
                'id_recipe' => 10,
                'id_user'   => 1,
                'created_at'=> date("Y-m-d H:i:s"),
        ...
        $this->db->table('opinion')->insertBatch($opinions);
